 ...
 */
export function getBodyModulePath(
  px: number,
  py: number,
  ...
  switch (shape) {
    case "rounded":
      return `M${px + 0.36},${py + 0.08}h0.28a0.28,0.28 0 0 1 0.28,0.28v0.28a0.28,0.28 0 0 1 -0.28,0.28h-0.28a0.28,0.28 0 0 1 -0.28,-0.28v-0.28a0.28,0.28 0 0 1 0.28,-0.28z`;

    case "dots":
      return `M${px + 0.5},${py + 0.5} m-0.43,0 a0.43,0.43 0 1,0 0.86,0 a0.43,0.43 0 1,0 -0.86,0`;
    ...
    case "heart":
      return (
        `M${px + 0.5},${py + 0.35} ` +
        `C${px + 0.5},${py + 0.2} ${px + 0.3},${py + 0.1} ${px + 0.18},${py + 0.25} ` +
        `C${px + 0.02},${py + 0.45} ${px + 0.2},${py + 0.7} ${px + 0.5},${py + 0.92} ` +
        `C${px + 0.8},${py + 0.7} ${px + 0.98},${py + 0.45} ${px + 0.82},${py + 0.25} ` +
        `C${px + 0.7},${py + 0.1} ${px + 0.5},${py + 0.2} ${px + 0.5},${py + 0.35} Z`
      );
    ...
    case "clover":
      return (
        `M${px + 0.5},${py + 0.25} m-0.30,0 a0.30,0.30 0 1,0 0.60,0 a0.30,0.30 0 1,0 -0.60,0 ` +
    ...
    case "tiny-dots":
      return `M${px + 0.5},${py + 0.5} m-0.34,0 a0.34,0.34 0 1,0 0.68,0 a0.34,0.34 0 1,0 -0.68,0`;
