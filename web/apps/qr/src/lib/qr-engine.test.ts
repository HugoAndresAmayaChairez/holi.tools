...
import type { QRConfig, BodyShape, EyeFrameShape, EyeBallShape } from './qr-engine';
...
describe('qr-engine', () => {
    describe('state', () => {
        ...
        it('should have default logo settings', () => {
            ...
            expect(state.config.logoBgEnabled).toBe(false);
            expect(state.config.logoBgShape).toBe('circle');
    ...
    describe('type exports', () => {
        it('should accept valid body shapes', () => {
            const validShapes: BodyShape[] = [
                'square', 'rounded', 'dots', 'tiny-dots', 'diamond',
                'star', 'clover', 'capsule', 'chain', 'pixel', 'water'
            ];
        ...
        it('should accept valid eye frame shapes', () => {
            const validShapes: EyeFrameShape[] = [
                'square', 'rounded', 'circle', 'diamond', 'cushion',
                'leaf', 'clover-frame', 'bevel', 'orbit', 'flux'
            ];
            validShapes.forEach(shape => {
        ...
        it('should accept valid eye ball shapes', () => {
            const validShapes: EyeBallShape[] = [
                'square', 'rounded', 'circle', 'diamond', 'star',
                'heart', 'hexagon', 'dots-grid', 'bars-h', 'bars-v'
            ];
            validShapes.forEach(shape => {
