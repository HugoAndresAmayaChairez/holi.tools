...
const en: TypstCopy = {
  ...
  waitingMath: "waiting for a closing $", compilerUnavailable: "The Typst compiler could not be loaded. Check your connection and try again.", retry: "Retry", problems: "Problems", warningLabel: "warning", showInEditor: "Show in editor",
  privacyPage: {
...
const es: TypstCopy = {
  ...
  waitingMath: "esperando el $ de cierre", compilerUnavailable: "No se pudo cargar el compilador de Typst. Revisa tu conexión e inténtalo de nuevo.", retry: "Reintentar", problems: "Problemas", warningLabel: "aviso", showInEditor: "Mostrar en el editor",
...
const zh: TypstCopy = {
  ...
  waitingMath: "等待闭合的 $", compilerUnavailable: "无法加载 Typst 编译器。请检查网络连接后重试。", retry: "重试", problems: "问题", warningLabel: "警告", showInEditor: "在编辑器中显示",
...
const hi: TypstCopy = {
  ...
  waitingMath: "बंद करने वाले $ की प्रतीक्षा", compilerUnavailable: "Typst कंपाइलर लोड नहीं हो सका। अपना कनेक्शन जाँचें और फिर से कोशिश करें।", retry: "फिर से कोशिश करें", problems: "समस्याएँ", warningLabel: "चेतावनी", showInEditor: "एडिटर में दिखाएँ",
...
const ar: TypstCopy = {
  ...
  waitingMath: "بانتظار علامة $ الختامية", compilerUnavailable: "تعذّر تحميل مُصرِّف Typst. تحقق من اتصالك وحاول مجددًا.", retry: "إعادة المحاولة", problems: "المشكلات", warningLabel: "تحذير", showInEditor: "إظهار في المحرر",
...
const bn: TypstCopy = {
  ...
  waitingMath: "বন্ধ করার $ এর অপেক্ষায়", compilerUnavailable: "Typst কম্পাইলার লোড করা যায়নি। সংযোগ পরীক্ষা করে আবার চেষ্টা করুন।", retry: "আবার চেষ্টা করুন", problems: "সমস্যা", warningLabel: "সতর্কতা", showInEditor: "এডিটরে দেখান",
...
const pt: TypstCopy = {
  ...
  waitingMath: "aguardando o $ de fechamento", compilerUnavailable: "Não foi possível carregar o compilador Typst. Verifique a conexão e tente de novo.", retry: "Tentar de novo", problems: "Problemas", warningLabel: "aviso", showInEditor: "Mostrar no editor",
